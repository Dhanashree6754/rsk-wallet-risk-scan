              ...
              >
                ...
                >
                  <div className="flex items-center gap-4 flex-1">
                    <div className="w-10 h-10 bg-[#FF6600]/20 rounded-full flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {openIndex === index ? (
                      <FaChevronUp className="text-[#FF6600] flex-shrink-0 text-xl" />
                    ) : (
                      <FaChevronDown className="text-gray-400 flex-shrink-0 text-xl group-hover:text-[#FF6600] transition-colors" />
                    )}
                  </div>
                </button>
                {openIndex === index && (
